                                    ...
                                    <div class="d-flex">
                                        <span class="input-group-btn mr-2">
                                            <button type="button" class="quantity-left-minus btn bd-un"
                                                data-type="minus" data-field="" onclick="onMinusQuantity(event)">
            ...
            <div class="cart-total mb-3">
                ...
                <form class="form-apply-discount">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-left px-3" placeholder="" name="discountName">
            ...
            <div class="cart-total mb-3">
                ...
                <form action="#" class="info">
                    <div class="form-group">
                        ...
                        <select class="form-select form-select-sm mb-3" id="province" aria-label=".form-select-sm">
