            ...
            <div class="row">
                <div class="col-lg-8 ftco-animate">
                    <div class="scrolling-pagination">
                                    ...
                                    <div class="blog-entry align-self-stretch d-md-flex">
                                        ...
                                        <div class="text d-block pl-md-4">
                                            <div class="meta mb-3">
                                                ...
                                                <div><a href="#">{{ $blog->username }}</a></div>
                        ...
                        {{-- <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry align-self-stretch d-md-flex">
                                <a href="{{ url('blog-singles') }}" class="block-20"
                                    style="background-image: url({{ asset('client/images/image1.jpg') }});">
                                </a>
                                <div class="text d-block pl-md-4">
                                    <div class="meta mb-3">
                                    ...
                                    <p><a href="{{ url('blog-singles') }}" class="btn btn-primary py-2 px-3">Đọc thêm</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry align-self-stretch d-md-flex">
                                <a href="{{ url('blog-singles') }}" class="block-20"
                                    style="background-image: url({{ asset('client/images/image2.jpg') }});">
                                </a>
                                <div class="text d-block pl-md-4">
                                    <div class="meta mb-3">
                                    ...
                                    <p>Đồ dùng gia đình thông minh là đồ gia dụng có những tính năng thông minh, với những
                                        giải pháp đa năng tiện ích. </p>
                                    <p><a href="{{ url('blog-singles') }}" class="btn btn-primary py-2 px-3">Đọc thêm</a>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry align-self-stretch d-md-flex">
                                <a href="{{ url('blog-singles') }}" class="block-20"
                                    style="background-image: url({{ asset('client/images/image3.jpg') }});">
                                </a>
                                <div class="text d-block pl-md-4">
                                    <div class="meta mb-3">
                                        <div><a href="#">19-12-2021</a></div>
                                    ...
                                    <h3 class="heading"><a href="#">Sale 90% các mặt hàng rau củ quả từ ngày
                        ...
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry align-self-stretch d-md-flex">
                                <a href="{{ url('blog-singles') }}" class="block-20"
                                    style="background-image: url({{ asset('client/images/image4.jpg') }});">
                                </a>
                                <div class="text d-block pl-md-4">
                                    <div class="meta mb-3">
                                        <div><a href="#">19-12-2021</a></div>
                                    ...
                                    <h3 class="heading"><a href="#">
                                            Shop best goods thêm các mặt hàng gia dụng nhằm đáp ứng nhu cầu của khách
                                            hàng</a></h3>
                                    <p>Khách hàng thường muốn các sản phẩm độc lạ và nhiều chức năng hơn. Chúng tôi thêm các
                                        sản phẩm để giải quyết </p>
                                    <p><a href="{{ url('blog-singles') }}" class="btn btn-primary py-2 px-3">Đọc thêm</a>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 d-flex ftco-animate">
                            <div class="blog-entry align-self-stretch d-md-flex">
                                <a href="{{ url('blog-singles') }}" class="block-20"
                                    style="background-image: url({{ asset('client/images/image5.jpg') }});">
                                </a>
                                <div class="text d-block pl-md-4">
                                    <div class="meta mb-3">
                                        <div><a href="#">19-12-2021</a></div>
                                    ...
                                    <h3 class="heading"><a href="#">
                                            Sinh nhật 8 tuổi của Shop best goods giảm giá sốc tất cả các mặt hàng lên đến
                                            99%</a></h3>
                                    <p>Chúc mừng sinh nhật Shop best goods với hàng ngàn quà tặng và voucher dành cho khách
                                        hàng.</p>
                                    <p><a href="{{ url('blog-singles') }}" class="btn btn-primary py-2 px-3">Đọc thêm</a>
                                    </p>
                                </div>
                ...
                <div class="col-lg-4 sidebar ftco-animate">
                    ...
                    <div class="sidebar-box ftco-animate">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="blog-img mr-4"
                                style="background-image: url({{ asset('client/images/image5.jpg') }});"></a>
                            <div class="text">
