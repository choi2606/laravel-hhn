      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Giỏ hàng</a></span> <span>tại nhà</span></p>
	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url({{asset('client/images/product3.jpg')}});"></div></td>
						        ...
						        <td class="quantity">
						        	<div class="input-group mb-3">
					             	<input  type="text" id="input_1" name="quantity" class="quantity form-control input-number" value="1" min="1" max="100">
					          	</div>
					          </td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url({{asset('client/images/product4.jpg')}});"></div></td>
						        ...
						        <td class="quantity">
						        	<div class="input-group mb-3">
					             	<input type="text" id="input_2" name="quantity" class="quantity form-control input-number" value="1" min="1" max="100">
					          	</div>
					          </td>
