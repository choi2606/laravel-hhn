		...
		<section class="ftco-section ftco-category ftco-no-pt">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<div class="row">
							<div class="col-md-6 order-md-last align-items-stretch d-flex">
								<div class="category-wrap-2 ftco-animate img align-self-stretch d-flex" style="background-image: url({{asset('client/images/category.jpg')}});">
							...
							<div class="col-md-6">
								<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url({{asset('client/images/category1.jpg')}});">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="localhost:5500/Shop%20diverse%20goods_master/Shop%20diverse%20goods-master/shop.html">Đồ ăn vặt</a></h2>
									</div>
								</div>
								<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url({{asset('client/images/category2.jpg')}});">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="localhost:5500/Shop%20diverse%20goods_master/Shop%20diverse%20goods-master/shop.html">Hàng đông mát</a></h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url({{asset('client/images/category3.jpg')}});">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="localhost:5500/Shop%20diverse%20goods_master/Shop%20diverse%20goods-master/shop.html">Thực phẩm</a></h2>
							</div>		
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url({{asset('client/images/category4.jpg')}});">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="localhost:5500/Shop%20diverse%20goods_master/Shop%20diverse%20goods-master/shop.html">Gia dụng</a></h2>
							</div>
						</div>
					</div>
				</div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="{{url('product-detail')}}" class="img-prod"><img class="img-fluid" src="{{asset('client/images/product1.jpg')}}" alt="Colorlib Template">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
	    					...
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							...
	    							<a href="{{url('product-detail')}}" class="buy-now d-flex justify-content-center align-items-center mx-1">
	    								<span><i class="ion-ios-cart"></i></span>
	    							</a>
	    							<a href="" id="produc_1" class="heart d-flex justify-content-center align-items-center ">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="{{url('product-detail')}}" class="img-prod"><img class="img-fluid" src="{{asset('client/images/product2.jpg')}}" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							...
	    							<a href="#" id="produc_2" class="heart d-flex justify-content-center align-items-center ">
	    								<span><i class="ion-ios-heart"></i></span>
	    							</a>
    							</div>
    						</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="{{url('product-detail')}}" class="img-prod"><img class="img-fluid" src="images/product3.jpg" alt="Colorlib Template">
	    					<div class="overlay"></div>
	    				</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							...
	    							<a href="#" id="produc_3" class="heart d-flex justify-content-center align-items-center ">
	    								<span><i class="ion-ios-heart"></i></span>
	    							</a>
    							</div>
    						</div>
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="{{url('product-detail')}}" class="img-prod"><img class="img-fluid" src="images/product4.jpg" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						...
    						<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							...
	    							<a href="#" id="produc_4" class="heart d-flex justify-content-center align-items-center ">
	    								<span><i class="ion-ios-heart"></i></span>
	    							</a>
    							</div>
    						</div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-sm ftco-animate">
    				<a href="#" class="partner"><img src="{{asset('/client/images/partner.jpg')}}" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<!-- <div class="col-sm ftco-animate">
