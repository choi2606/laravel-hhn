            ...
            <div class="card-body card-block">
                <form method="post" action="add-blogs" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" id="contentInput" name="blogContent" class="form-control"
                            placeholder="Thêm nội dung vào dây" rows='9' required></textarea>
                    </div>
                    <div class="form-group">
                        <input type="file" id="ImageInput" name="blogImage" accept="image/png, image/gif, image/jpeg">
                    </div>
                    ...
                    <table class="table table-responsive-xl">
                        ...
                        <tbody class="body-blog">
                            ...
                            <tr class="d-flex justify-content-between">
                                ...
                                <td class="w-50"><a href="{{ url('/blog-singles/'. $blog->blog_id)}}"><u>{{ $blog->title }}</u></a></td>
                                <td style="white-space: pre-line" class="w-100 linelimit-6">{{ $blog->text }}
                                </td>
                                <td class="w-50">
                                    <img src="{{ asset('client/images/blog/' . $blog->image_url) }}" alt="">
                                </td>
                                <td scope="col" class="w-50">
                                    {{ \Carbon\Carbon::parse($blog->created_at)->format('d/m/Y') }}
                                </td>
                                <td class="w-20" align="end">
                                    <a href="#" data-target="#updateFormModal" data-toggle="modal" data-whatever={{
                                        $blog->blog_id }}
            ...
            <div class="card modal-dialog modal-lg modal-content" role="document">
                ...
                <div class="modal-body card-block">
                    <form method="post" action="update-blog" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="titleInput">Tiêu đề</label>
                            <input type="text" id="titleUpdateInput" name="blogTitleUpdate" class="form-control"
                                placeholder="Viết tiêu đề vào đây." required>
                        </div>
                        <div class="form-group">
                            <label for="contentInput">Nội dung</label>
                            <textarea style="white-space: pre-line" type="text" id="contentUpdateInput"
                                name="blogContentUpdate" class="form-control" placeholder="Thêm nội dung vào dây"
